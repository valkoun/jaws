...
class Upgrader_0810To0811 extends JawsUpgraderStage
{
    ...
    function Run()
    {
        ...
        log_upgrade("Cleaning previous maps cache data files - step 0.8.10->0.8.11");
        ...
        log_upgrade("Cleaning previous registry cache data files - step 0.8.10->0.8.11");
        ...
        log_upgrade("Cleaning previous acl cache data files - step 0.8.10->0.8.11");
