...
class Upgrader_088To089 extends JawsUpgraderStage
{
    ...
    function Run()
    {
        ...
        log_upgrade("Cleaning previous maps cache data files - step 0.8.8->0.8.9");
        ...
        log_upgrade("Cleaning previous registry cache data files - step 0.8.8->0.8.9");
        ...
        log_upgrade("Cleaning previous acl cache data files - step 0.8.8->0.8.9");
