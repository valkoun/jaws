...
class Upgrader_086To087 extends JawsUpgraderStage
{
    ...
    function Run()
    {
        ...
        log_upgrade("Cleaning previous maps cache data files - step 0.8.6->0.8.7");
        ...
        log_upgrade("Cleaning previous registry cache data files - step 0.8.6->0.8.7");
        ...
        log_upgrade("Cleaning previous acl cache data files - step 0.8.6->0.8.7");
