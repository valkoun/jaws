...
class Upgrader_083To084 extends JawsUpgraderStage
{
    ...
    function Run()
    {
        ...
        log_upgrade("Cleaning previous maps cache data files - step 0.8.3->0.8.4");
        ...
        log_upgrade("Cleaning previous registry cache data files - step 0.8.3->0.8.4");
        ...
        log_upgrade("Cleaning previous acl cache data files - step 0.8.3->0.8.4");
