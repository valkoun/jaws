...
class Upgrader_085To086 extends JawsUpgraderStage
{
    ...
    function Run()
    {
        ...
        $gadgets = array('ControlPanel', 'UrlMapper', 'Users', 'Layout', 'Tms', 'Settings');
        ...
        log_upgrade("Cleaning previous maps cache data files - step 0.8.5->0.8.6");
        ...
        log_upgrade("Cleaning previous registry cache data files - step 0.8.5->0.8.6");
        ...
        log_upgrade("Cleaning previous acl cache data files - step 0.8.5->0.8.6");
