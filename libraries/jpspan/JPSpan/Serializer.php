...
* @version $Id: Serializer.php,v 1.4 2005/04/25 10:13:20 harryf Exp $
*/
//-----------------------------------------------------------------------------
...
class JPSpan_Serializer {
    ...
    * @static
    */
    function serialize($data, $encoding = 'xml') {
        if ($encoding == 'json') {
            require_once JPSPAN . 'Serializer/JSON.php';
            $S = new JPSpan_Serializer_JSON();
