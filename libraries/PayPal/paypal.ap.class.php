...
class PayPalAdaptivePayments
{
	...
	function PayPalAdaptivePayments($DataArray)
	{
		...
		$this -> APIButtonSource = isset($DataArray['ButtonSource']) ? $DataArray['ButtonSource'] : 'Jaws';
	...
	function BuildHeaders()
	{
		...
		if($this -> Sandbox)
			array_push($headers, 'X-PAYPAL-SANDBOX-EMAIL-ADDRESS: info@example.org');
	...
	{		
		...
		$PayRequestFields = array(
			...
			'CurrencyCode' => '', 							// Required.  The code for the currency in which the payment is made.  You can specify only one currency, regardless of the number of receivers.
