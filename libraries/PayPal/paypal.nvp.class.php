...
class PayPal
{
	...
	*/
	...
	function DoCapture($DataArray)
	{
		...
		*/
		...
		$DCFieldsNVP = '&METHOD=DoCapture&BUTTONSOURCE=Syntacts_PHP_Class_DC';
	...
	function DoAuthorization($DataArray)
	{
		...
		*/
		...
		$DAFieldsNVP = '&METHOD=DoAuthorization&BUTTONSOURCE=Syntacts_PHP_Class_DA';
	...
	function DoReauthorization($DataArray)
	{
		...
		*/
		...
		$DRFieldsNVP = '&METHOD=DoReAuthorization&BUTTONSOURCE=Syntacts_PHP_Class_DRA';
	...
	function DoVoid($DataArray)
	{
		...
		*/
		...
		$DVFieldsNVP = '&METHOD=DoVoid&BUTTONSOURCE=Syntacts_PHP_Class_DV';
	...
	*/
	...
	function MassPay($DataArray)
	{
		...
		$Item1 = array(
							'l_email' => '', 							// Required.  Email address of recipient.  OR ReceiverID of recipient. You must specify either L_EMAIL or L_RECEIVERID but you must not mix the two.
		...
		*/
		...
		$MPFieldsNVP = '&METHOD=MassPay&BUTTONSOURCE=Syntacts_PHP_Class_MP';
		$MPItemsNVP = '';
	...
	*/
	...
	function RefundTransaction($DataArray)
	{
		...
		*/
		...
		$RTFieldsNVP = '&METHOD=RefundTransaction&BUTTONSOURCE=Syntacts_PHP_Class_RT';
	...
	*/
	...
	function GetTransactionDetails($DataArray)
	{
		...
		*/
		...
		$GTDFieldsNVP = '&METHOD=GetTransactionDetails&BUTTONSOURCE=Syntacts_PHP_Class_GTD';
	...
	*/
	...
	function DoDirectPayment($DataArray)
	{
		...
		*/
		...
		$DPFieldsNVP = '&METHOD=DoDirectPayment&BUTTONSOURCE=Syntacts_PHP_Class_DDP';
		$CCDetailsNVP = '';
		$PayerInfoNVP = '';
		$PayerNameNVP = '';
		$BillingAddressNVP = '';
	...
	*/
	...
	function SetExpressCheckout($DataArray)
	{
		...
		*/		
		...
		$SECFieldsNVP = '&METHOD=SetExpressCheckout&BUTTONSOURCE=Syntacts_PHP_Class_SEC';
		$SurveyChoicesNVP = '';
		$PaymentsNVP = '';
		$ShippingOptionsNVP = '';
		...
		if($this -> Sandbox)
			$NVPResponseArray['REDIRECTURL'] = 'https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&' . $SkipDetailsOption . '&token=' . (isset($NVPResponseArray['TOKEN']) ? $NVPResponseArray['TOKEN'] : '');
		else
			$NVPResponseArray['REDIRECTURL'] = 'https://www.paypal.com/cgi-bin/webscr?cmd=_express-checkout&' . $SkipDetailsOption . '&token=' . (isset($NVPResponseArray['TOKEN']) ? $NVPResponseArray['TOKEN'] : '');
	...
	function GetExpressCheckoutDetails($Token)
	{
		...
		*/
		...
		$GECDFieldsNVP = '&METHOD=GetExpressCheckoutDetails&BUTTONSOURCE=Syntacts_PHP_Class_GECD&TOKEN=' . $Token;
	...
	function DoExpressCheckoutPayment($DataArray)
	{
		...
		*/	
		...
		$DECPFieldsNVP = '&METHOD=DoExpressCheckoutPayment&BUTTONSOURCE=Syntacts_PHP_Class_DECP';
		$PaymentsNVP = '';
	...
	*/
	...
	function TransactionSearch($DataArray)
	{
		...
		*/
		...
		$TSFieldsNVP = '&METHOD=TransactionSearch&BUTTONSOURCE=Syntacts_PHP_Class_TS';
		$PayerNameNVP = '';
	...
	*/
	...
	function DoNonReferenceCredit($DataArray)
	{
		...
		*/
		...
		$DNRCFieldsNVP = '&METHOD=DoNonReferencedCredit&BUTTONSOURCE=Syntacts_PHP_Class_DNRC';
		$CCDetailsNVP = '';
		$PayerInfoNVP = '';
		$BillingAddressNVP = '';
	...
	function DoReferenceTransaction($DataArray)
	{
		...
		$DRTFieldsNVP = '&METHOD=DoReferenceTransaction&BUTTONSOURCE=Syntacts_PHP_Class_DRT';
		$CCDetailsNVP = '';
		$PayerInfoNVP = '';
		$BillingAddressNVP = '';
		$ShippingAddressNVP = '';
	...
	*/
	...
	function GetBalance($DataArray)
	{
		...
		*/
		...
		$GBFieldsNVP = '&METHOD=GetBalance&BUTTONSOURCE=Syntacts_PHP_Class_GB';
	...
	*/
	...
	{
		$GPFieldsNVP = '&METHOD=GetPalDetails&BUTTONSOURCE=Syntacts_PHP_Class_GPD';
	...
	*/
	...
	function AddressVerify($DataArray)
	{
		...
		*/
		...
		$AVFieldsNVP = '&METHOD=AddressVerify&BUTTONSOURCE=Syntacts_PHP_Class_AV';
	...
	*/
	...
	function ManagePendingTransactionStatus($DataArray)
	{
		...
		*/
		...
		$MPTSFieldsNVP = '&METHOD=ManagePendingTransactionStatus&BUTTONSOURCE=Syntacts_PHP_Class_MPTS';
	...
	*/
	...
	function CreateRecurringPaymentsProfile($DataArray)
	{
		...
		*/
		...
		$CRPPFieldsNVP = '&METHOD=CreateRecurringPaymentsProfile&BUTTONSOURCE=Syntacts_PHP_Class_CRPP';
	...
	function GetRecurringPaymentsProfileDetails($DataArray)
	{
		...
		*/
		...
		$GRPPDFieldsNVP = '&METHOD=GetRecurringPaymentsProfileDetails&BUTTONSOURCE=Syntacts_PHP_Class_GRPPD';
	...
	function ManageRecurringPaymentsProfileStatus($DataArray)
	{
		...
		*/
		...
		$MRPPSFieldsNVP = '&METHOD=ManageRecurringPaymentsProfileStatus&BUTTONSOURCE=Syntacts_PHP_Class_MRPPS';
	...
	function BillOutstandingAmount($DataArray)
	{
		...
		*/
		...
		$BOAFieldsNVP = '&METHOD=BillOutstandingAmount&BUTTONSOURCE=Syntacts_PHP_Class_BOA';
	...
	function UpdateRecurringPaymentsProfile($DataArray)
	{
		...
		*/
		...
		$URPPFieldsNVP = '&METHOD=UpdateRecurringPaymentsProfile&BUTTONSOURCE=Syntacts_PHP_Class_URPP';
	...
	function BillAgreementUpdate($DataArray)
	{
		...
		*/
		...
		$BAUFieldsNVP = '&METHOD=BillAgreementUpdate&BUTTONSOURCE=Syntacts_PHP_Class_BAU';
	...
	*/
	...
	function SetMobileCheckout($DataArray)
	{
		...
		*/
		...
		$SMCFieldsNVP = '&METHOD=SetMobileCheckout&BUTTONSOURCE=Syntacts_PHP_Class_SMC';
	...
	function DoMobileCheckoutPayment($DataArray)
	{
		...
		*/
		...
		$DMCPFieldsNVP = '&METHOD=DoMobileCheckoutPayment&BUTTONSOURCE=Syntacts_PHP_Class_DMCP';
	...
	function SetAuthFlowParam($DataArray)
	{
		...
		$SetAuthFlowParamFieldsNVP = '&METHOD=SetAuthFlowParam&BUTTONSOURCE=Syntacts_PHP_Class_SAFP';
	...
	{
		$GetAuthDetailsFieldsNVP = '&METHOD=GetAuthDetails&BUTTONSOURCE=Syntacts_PHP_Class_GAD&TOKEN=' . $Token;
	...
	{
		$GetAccessPermissionsDetailsNVP = '&METHOD=GetAccessPermissionsDetails&BUTTONSOURCE=Syntacts_PHP_Class_GACPD&TOKEN=' . $Token;
	...
	function SetAccessPermissions($DataArray)
	{
		...
		$SetAccessPermissionsNVP = '&METHOD=SetAccessPermissions&BUTTONSOURCE=Syntacts_PHP_Class_SAP';
	...
	{
		$UpdateAcccessPermissionsNVP = '&METHOD=UpdateAccessPermissions&BUTTONSOURCE=Syntacts_PHP_Class_UAP&PAYERID=' . $PayerID;	
