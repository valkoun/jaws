 ...
 * @version    CVS: $Id: Safe.php 195032 2005-09-03 17:39:39Z bolk $
...
class HTML_Safe 
{
    ...
    /**
     * Stores strict about deleteTags or not
     *
     * @var boolean
     * @access private
     */
    ...
    function _openHandler(&$parser, $name, $attrs) 
    {
        ...
        if ($this->strict && in_array($name, $this->deleteTags)) {
            return true;
        }
     ...
     * @access public
     */
    function parse($doc, $strict = true) 
    {
       $this->strict = $strict;
