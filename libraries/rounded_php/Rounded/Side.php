...
{	
	...
	function Rounded_Side($params)
	{
		...
		$this->foreground = 'CCCCCC';		# color of corner
		$this->background = 'FFFFFF';		# color of background
		$this->borderwidth = 0;			# width of border
		$this->bordercolor = '000000';	# color of border (if border width > 0)
		$this->side = 'top';				# side of the rectangle to generate
