<?php
require_once(JAWS_PATH . 'libraries/vimeo-php-lib-master/vimeo.php');
session_start();

// Create the object and enable caching
$vimeo = new phpVimeo('b751ca8391b4b0b1e015ac342193693fb108c64f', '2dfe553bfe78315413d825935284eed36fba3bcd');
...
<body>
    ...
    <p>This is a basic example of Vimeo's new OAuth authentication method. Everything is saved in session vars, so <a href="index.php?action=IncludeLibrary&path=%2Flibraries%2Fvimeo-php-lib-master%2Findex.php&clear=all">click here if you want to start over</a>.</p>
