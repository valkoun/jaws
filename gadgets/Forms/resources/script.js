...
function showForm(type, count) {
	...
	var dItemGadget = document.createElement('div');
	dItemGadget.setAttribute('id', type+'Form_NEXT' + count);
	dItemGadget.setAttribute('class', 'syntacts-form-row');
	dItemGadget.setAttribute('className', 'syntacts-form-row');
	dItemGadget.style.backgroundColor = background_color;
	dItemGadget.style.padding = '5px';
	dItemGadget.style.border = '1pt dashed #DDDDDD';
	var response = formsSync.getSyntactsUpdateForm(type);
	dItemGadget.innerHTML = response;
	/*
	dItemGadget.innerHTML = "<div style=\"text-align: right;\"><a id=\"answer"+count+"Delete\" style=\"display: none;\" href=\"javascript:void(0);\" onclick=\"document.getElementById('ProductName"+count+"').value = ''; document.getElementById('ProductPrice"+count+"').value = ''; document.getElementById('ProductDescription"+count+"').value = ''; document.getElementById('ProductWeight"+count+"').value = ''; document.getElementById('ProductImage"+count+"').value = '';\">Delete</a></div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div class=\"field_label\"><a name=\"Name\"><b>Product Name:</b></a><img src=\"images/stock/help-browser.png\" border=\"0\" style=\"cursor: pointer; cursor: hand;\" title=\"header=[<p style='padding: 1px' align='left'>Help</p>] body=[<p style='padding: 1px' align='left'>This is the title of the product you are adding.</p>] delay=[10] fade=[on] fadespeed=[.2]\"></div><div class=\"field_entry\"><b>&nbsp;<input ID=\"ProductName"+count+"\" type=\"text\" NAME=\"ProductName"+count+"\" VALUE=\"\" onChange=\"if (this.value.length > 0) {document.getElementById('answer"+count+"Delete').style.display = '';} else {document.getElementById('answer"+count+"Delete').style.display = 'none';};\" /></b></div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div style=\"float: none; clear: both; font-size: 0.01em;\">&nbsp;</div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div class=\"field_label\"><a name=\"Price\"><b>Price:</b></a><img src=\"images/stock/help-browser.png\" border=\"0\" style=\"cursor: pointer; cursor: hand;\" title=\"header=[<p style='padding: 1px' align='left'>Help</p>] body=[<p style='padding: 1px' align='left'>This is the final price of the product.</p>] delay=[10] fade=[on] fadespeed=[.2]\"></div><div class=\"field_entry\"><b>&nbsp;<input ID=\"ProductPrice"+count+"\" type=\"text\" NAME=\"ProductPrice"+count+"\" VALUE=\"\" onChange=\"if (this.value.length > 0) {document.getElementById('answer"+count+"Delete').style.display = '';};\" /></b></div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div style=\"float: none; clear: both; font-size: 0.01em;\">&nbsp;</div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div class=\"field_label\"><a name=\"Description\"><b>Description:</b></a><img src=\"images/stock/help-browser.png\" border=\"0\" style=\"cursor: pointer; cursor: hand;\" title=\"header=[<p style='padding: 1px' align='left'>Help</p>] body=[<p style='padding: 1px' align='left'>Describe the product here.</p>] delay=[10] fade=[on] fadespeed=[.2]\"></div><div class=\"field_entry\"><b>&nbsp;<textarea ID=\"ProductDescription"+count+"\" NAME=\"ProductDescription"+count+"\" onChange=\"if (this.value.length > 0) {document.getElementById('answer"+count+"Delete').style.display = '';};\"></textarea></b></div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div style=\"float: none; clear: both; font-size: 0.01em;\">&nbsp;</div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div class=\"field_label\"><a name=\"Weight\"><b>Weight:</b></a><img src=\"images/stock/help-browser.png\" border=\"0\" style=\"cursor: pointer; cursor: hand;\" title=\"header=[<p style='padding: 1px' align='left'>Help</p>] body=[<p style='padding: 1px' align='left'>This is the weight (in lbs.) of the product.</p>] delay=[10] fade=[on] fadespeed=[.2]\"></div><div class=\"field_entry\"><b>&nbsp;<input ID=\"ProductWeight"+count+"\" type=\"text\" NAME=\"ProductWeight"+count+"\" VALUE=\"\" onChange=\"if (this.value.length > 0) {document.getElementById('answer"+count+"Delete').style.display = '';};\" /></b></div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div style=\"float: none; clear: both; font-size: 0.01em;\">&nbsp;</div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div class=\"field_label\"><a name=\"Image\"><b>Add Attachment(s):</b></a><img src=\"images/stock/help-browser.png\" border=\"0\" style=\"cursor: pointer; cursor: hand;\" title=\"header=[<p style='padding: 1px' align='left'>Help</p>] body=[<p style='padding: 1px' align='left'>Add any images of the product here.</p>] delay=[10] fade=[on] fadespeed=[.2]\"></div><div class=\"field_entry\"><b>&nbsp;<input value=\"Add Image\" class=\"button\" type=\"button\" onclick=\"createImageRow("+imagecount+","+type+","+count+");\" /></b></div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div style=\"float: none; clear: both; font-size: 0.01em;\">&nbsp;</div>";
	*/
	dItem.appendChild(dItemGadget);
	...
	//Effect.Appear(dItem.id, {duration:1});
	addCount = count+1;
	var dItemHolder = document.createElement('div');
	dItemHolder.appendChild(dItemGadget);
	return dItemHolder.innerHTML;	
}

/**
 * Creates a new Row for an answer to a form question
 */
function createImageRow(count,type,rowcount) {
	var dItemGadget = document.createElement('div');
	dItemGadget.style.padding = '10px';
	dItemGadget.innerHTML = "<div style=\"text-align: right;\"><a id=\"answer"+count+"Delete\" style=\"display: none;\" href=\"javascript:void(0);\" onclick=\"document.getElementById('ProductName"+count+"').value = ''; document.getElementById('ProductPrice"+count+"').value = ''; document.getElementById('ProductDescription"+count+"').value = ''; document.getElementById('ProductWeight"+count+"').value = ''; document.getElementById('ProductImage"+count+"').value = '';\">Delete</a></div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div class=\"field_label\"><a name=\"Image\"></a>Attachment:</div>";
	dItemGadget.innerHTML = dItemGadget.innerHTML + "<div style=\"float: none; clear: both; font-size: 0.01em;\">&nbsp;</div>";
	
	imageCount = count+1;
	
	var dItemHolder = $(type+'Form_NEXT'+rowcount);
	dItemHolder.appendChild(dItemGadget);
	return dItemHolder.innerHTML;	
}
...
function prefillForm(id, elements, form_name)
{
	...
	if (document.forms[form_name] && id) {
		...
		var property = formsSync.getproperty(id);
...
function sizeFrame66() {
	...
	fr66.setAttribute("src", "iframetest_resize1.html?height="+height+"&object=evision_updates_frame"); 
...
function showWindow(action, id) {
	var task_id = null;
	content = "This dialog is coming soon.";
	if (action == 'AddStore') {
		content = '<div>Tell us about the item you wish to add using the form below.</div>' + showForm(action,addCount);
		//content = 'Add new product is not yet working.';
	} else if (action == 'DeleteStore') {
	}
	if (action == 'edit' && id) {
		task_id = parseInt(id.replace('div_', ''));
		content = "Viewing tickets is coming soon.";
		//url = url + '&id='+task_id;
	}
	content = '<div style="min-width: 400px; padding: 10px;">'+content+'</div>';
	//w1 = new UI.URLWindow({
	w1 = new UI.Window({
	  theme: "simpleblue",
	  shadow: true,
	...
	if ($('body')) {
		var items = $('body').getElementsByTagName('div')[1].getElementsByTagName('a');
		for (var i = 0; i < items.length; i++) {
			if (items[i].innerHTML.indexOf('Custom Page') > -1) {
				currentItem = $(items[i]);
				break;
			}
		}
...
var forms = new formsadminajax(FormsCallback);

var formsSync = new formsadminajax();
